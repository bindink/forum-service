...
@Service("updatePostAuthManager")
@RequiredArgsConstructor
public class UpdatePostCustomAuthorizationManager implements AuthorizationManager<RequestAuthorizationContext> {
    ...
    public AuthorizationDecision check(Supplier authentication, RequestAuthorizationContext authorizationContext) {
        ...
        return new AuthorizationDecision (post != null && userName.equals(post.getAuthor()));
    }
}
